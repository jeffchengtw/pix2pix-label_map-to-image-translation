...
class ArgumentParserWrapper:
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', type=str, default='vishay', help='Name of dataset')
        ...
        self.parser.add_argument('--input_nc', type=int, default=1, help='Number of input channels')
        self.parser.add_argument('--output_nc', type=int, default=1, help='Number of output channels')
